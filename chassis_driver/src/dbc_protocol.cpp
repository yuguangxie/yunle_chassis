...
const std::unordered_map<uint32_t, MessageDefinition> kMessageById = {
  {256U, {"BMS_Status", 256U, false, 8U, "BMS", {
      {"BMS_Voltage", 0, 16, ByteOrder::Intel, ValueType::Unsigned, 0.1, 0.0, 0.0, 100.0, "V"},
      {"BMS_Current", 16, 16, ByteOrder::Intel, ValueType::Signed, 0.1, 0.0, -500.0, 500.0, "A"},
      {"BMS_SOC", 32, 16, ByteOrder::Intel, ValueType::Unsigned, 1, 0.0, 0.0, 100.0, "%"},
    }}},
  {119U, {"VCU_Warning_Level", 119U, false, 8U, "VCU", {
      {"BMS_SOC_Warning", 0, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"MCU_Disconnect_Warning", 3, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"MCU_Motor_Warning", 6, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"MCU_Speed_Warning", 9, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"Steering_Disconnect_Warning", 12, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"Steering_Lock_Warning", 15, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"Steering_Uncontrollable_Warning", 18, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"Steering_Error_Warning", 21, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
      {"Brake_Error_Warning", 24, 3, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 7.0, ""},
    }}},
  ...
  {81U, {"VCU_CCU_Status", 81U, false, 8U, "VCU", {
      ...
      {"Touch_Brake_Request_Status", 35, 1, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 1.0, ""},
      {"Handle_Brake_Request_Status", 36, 1, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 1.0, ""},
      {"Handle_Mode_Flag_Status", 37, 1, ByteOrder::Intel, ValueType::Unsigned, 1.0, 0.0, 0.0, 1.0, ""},
...
/** 从 8 字节 CAN payload 中提取小端 bit 字段。 */
...
/** 从 8 字节 CAN payload 中提取大端（Motorola）bit 字段。 */
...
/** 将大端（Motorola）bit 字段写入 8 字节 CAN payload。 */
